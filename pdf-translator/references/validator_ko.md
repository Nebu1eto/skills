...
For translated documents with dialogue:

- Character voice should be distinct and consistent
- Speech levels (해요체, 합쇼체, 해체, etc.) must match context
...
## Academic Korean Validation

For academic documents, additionally check:

### Formal Tone
| Issue | Example | Fix |
|-------|---------|-----|
| Casual ending | ~거든요 | ~기 때문이다 |
| Colloquial | 되게 많이 | 매우 많이 |
| Personal | 내가 생각하기에 | 본 연구에서는 |

### Technical Terms
- First occurrence should include original term
- Consistent use throughout
- Standard Korean translations when available
...
- [ ] No source language text remains (unless intentional)
- [ ] Pronouns are used sparingly and naturally
- [ ] Sentence endings are varied and natural
- [ ] Honorifics are consistent (if applicable)
