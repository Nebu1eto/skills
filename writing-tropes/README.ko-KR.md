...
명확한 주장, 출처 기준, 매체에 맞는 형식을 지키며 글을 작성하고 다듬는 스킬입니다. 모든 언어에서 해당 언어의 자연스러운 관용 표현과 문장 구조를 사용합니다.
...
- 모든 언어에서 해당 언어의 자연스러운 관용 표현과 문장 구조를 사용합니다. 영어 표현이나 연어를 직역하지 않습니다.
...
이 파일은 스타일, 출처 표기, 인용 무결성, 형식, 로컬라이제이션, 최종 자체 점검 규칙의 기준입니다.
